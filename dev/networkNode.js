...
//register a node and broadcast that node to whole network
...
app.post('/register-nodes-bulk', function(req, res) {
    ...
    allNetworkNodes.forEach(networkNodeUrl => {
        const nodeNotAlreadyNotPresent = bitcoin.networkNodes.indexOf(networkNodeUrl) === -1
        const notCurrentNode = bitcoin.currentNodeUrl !== networkNodeUrl
        if(nodeNotAlreadyNotPresent && notCurrentNode) bitcoin.networkNodes.push(networkNodeUrl)
    })
